...
max_value = find_max_value(root)
print(f"\nНайбільше значення в дереві після видалення: {max_value}")
min_value = find_min_value(root)
print(f"\nНайменше значення в дереві після видалення: {min_value}")
total_sum = sum_of_values(root)
print(f"\nСума всіх значень у дереві після видалення: {total_sum}")